...
<body>
	...
	<div class="container">
			<div class="row">
				...
				<form id="searchForm" class="form-inline" method="post" action="/ProductServlet?method=auditSaleApplyPage">
					...
					<div class="form-group">
					    ...
					    <input class="form-control" type="text" name="beginDate" id="beginDate" value="${qo.beginDate}" />to
					    <input class="form-control" type="text" name="endDate" id="endDate" value="${qo.endDate}" />
					</div>
					<div class="form-group">
						<button id="query" class="btn btn-success"><i class="icon-search"></i> Search</button>
					</div>
				</form>
						...
						<c:forEach var="info" items="${pageResult.listData }">
							<tr>
								...
								<td>
									...
									<a href="javascript:void(-1);" class="auditClass" data-json='${info.jsonString}'>Audit</a>
									</c:if>
								</td>
							</tr>
						</c:forEach>
		      ...
		      <div class="modal-body">
		      	<form class="form-horizontal" id="editform" method="post" action="/">
					<fieldset>
						...
						<div class="row">
				        	<label class="col-sm-2 control-label" for="name">Applicant Email</label>
				        	<div class="col-sm-4">
				        		<label class="form-control" name="applierEmail" id="applierEmail"></label>
				        	</div>
						...
						<div class="row">
				        	<label class="col-sm-2 control-label" for="name">Bargain Status</label>
				        	<div class="col-sm-4">
						...
						<br>
						<div class="row">
				        	<label class="col-sm-2 control-label" for="name">Picture 1</label>
				        	<div class="col-sm-4">
				        		<img src="" id="picture1" style="width:150px;height:150px;"/>
				        	</div>
				        	<label class="col-sm-2 control-label" for="name">Picture 2</label>
				        	<div class="col-sm-4">
						...
						<br>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="name">Audit remark</label>
				        	<div class="col-sm-6">
